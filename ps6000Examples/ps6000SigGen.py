...
# This example opens a 6000 driver device, sets up the signal generator to produce a sine wave, then a square wave
...
# shots = 0
# sweeps = 0
# triggerType = ctypes.c_int16(0) = PS6000_SIGGEN_NONE
