...
for k = toSegmentIndex+1:-1:1
    triggerInfo(k) = ps6000aStructs.tPicoTriggerInfo.members;
...
[status.getTriggerInfo] = invoke(ps6000aDeviceObj,'ps6000aGetTriggerInfo',pTriggerInfo,fromSegmentIndex, numCaptures);
